...
public interface UserMapper {
	...
	void likePost(int userId, int boardId); // 게시글 좋아요 누르기
	void cancleFav(int userId, int boardId); // 게시글 좋아요 취소하기
	Fav favHistory(int userId, int boardId); // 해당글 좋아요 내역이 있는지 확인
